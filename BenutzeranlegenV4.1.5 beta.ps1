...
V4.1.4 Gruppenzugehörigkeit Nürnberg angepasst
V4.1.5 Gruppenexistenz-Prüfung hinzugefügt
#>
...
(4.1.5)Einfügen einer Warnung wenn eine Gruppe schon existiert - ye
(4.1.5)Bei $grouppruef nach Gruppe suchen um fälschlicherweise im falschen Kurs anlegen zu vermeiden - nope
(4.1.5)Anpassen des Passwort-Generators um missverständliche Zeichen zu vermeiden - ye
(4.1.5)Einfügen von Abfrage nach Trainer, um Trainerrechte zu vergeben
--> entfernen von abfrage nach sgb oder firmenkunden; Exception für Gruppenwarnung einbauen; VMM-Rollenerstellung anpassen; Add-TeamUser überarbeiten /wg ganzes Team wird hinzugefügt 
Entfernen von Aliassen
Entfernen von überflüsigen Variablen
    ...
    switch($Standort){
        ...
        default {"Fehler bitte Standort eingeben"}
            ...
            while($trainer -ne "y" -and $trainer -ne "n"){
                ...
                $trainer = Read-Host -Prompt "Traineraccount? [y/n]"
    
                if ($trainer -ne "y" -and $trainer -ne "n") {
