...
<Window
    ...
    <RadioButton GroupName="test" Name="radioButton" Content="Nein" HorizontalAlignment="Left" Height="15" VerticalAlignment="Top" Width="84" Margin="677,180,0,0" />
    <RadioButton GroupName="test" Name="radioButton1" Content="Ja" HorizontalAlignment="Left" Height="15" VerticalAlignment="Top" Width="85" Margin="576,180,0,0"/>
    <TextBlock Name="radios" Text="Traineraccount? (Bei mehreren Accounts sind alle betroffen)" HorizontalAlignment="Left" Height="28" VerticalAlignment="Top" Width="376" Margin="24,180,0,0"/>
    <TextBox Name="textBox" HorizontalAlignment="Left" Height="19" Margin="163,309,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="272"/>
        <Label Name="label1" Content="Kursname:" HorizontalAlignment="Left" Height="29" VerticalAlignment="Top" Width="76" Margin="38,304,0,0"/>
    </Grid>
</Window>
"@
#Read XAML
...
$button.Add_Click({
    ...
    foreach ($radio in $RadioButton.GroupName.test){
        Write-Host $radio
    }
